...
#ifndef H_HOMACOIN_SCRIPT
#define H_HOMACOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CHomacoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Homacoin always counted CHECKMULTISIGs
