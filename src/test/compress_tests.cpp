...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1HOMA 10000

// amounts 50 .. 45000000
#define NUM_MULTIPLES_50HOMA 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(45000000*COIN, 0x1406f40));
    ...
    for (uint64 i = 1; i <= NUM_MULTIPLES_1HOMA; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64 i = 1; i <= NUM_MULTIPLES_50HOMA; i++)
