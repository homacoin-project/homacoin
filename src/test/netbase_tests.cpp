...
{
    BOOST_CHECK(TestSplitHost("www.homacoin.org", "www.homacoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.homacoin.org]", "www.homacoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.homacoin.org:80", "www.homacoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.homacoin.org]:80", "www.homacoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4448", "127.0.0.1", 4448));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4448", "127.0.0.1", 4448));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4448", "::ffff:127.0.0.1", 4448));
    BOOST_CHECK(TestSplitHost("[::]:4448", "::", 4448));
    BOOST_CHECK(TestSplitHost("::4448", "::4448", -1));
    BOOST_CHECK(TestSplitHost(":4448", "", 4448));
    BOOST_CHECK(TestSplitHost("[]:4448", "", 4448));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4448", "127.0.0.1:4448"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4448", "[::]:4448"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
