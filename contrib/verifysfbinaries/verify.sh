...
WORKINGDIR="/tmp/homacoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/homacoin/Homacoin/homacoin-0.8.6/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/homacoin/Homacoin/"
VERSIONPREFIX="homacoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'homacoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[homacoin-]<version>-[rc[0-9]] (example: homacoin-0.7.1-rc1)"
   echo "wget output:"
